  ...
  return (
    <section className="bg-black py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-xl sm:text-2xl md:text-3xl mb-4 text-gradient font-bold">
        ...
        {specs.map((spec, index) => (
          <div
            key={index}
            className="flex flex-col items-center bg-gray-900 rounded-2xl p-6 hover:bg-gray-800 active:bg-gray-700 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer"
          >
